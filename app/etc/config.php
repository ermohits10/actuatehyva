...
return [
    'modules' => [
        ...
        'Actuate_CartAttributes' => 1,
        'Actuate_ConfigurableProduct' => 1,
        'Actuate_CustomCmsLayout' => 1,
        'Actuate_FeaturedCategories' => 1,
        'Actuate_FeaturedCategory' => 1,
        'Mirasvit_SearchUltimate' => 1,
        'Mirasvit_Seo' => 1,
        'Actuate_Option' => 1,
        'Actuate_ProductAttribute' => 1,
        'Actuate_RedirectSimpleProducts' => 1,
        'Actuate_RelevantProducts' => 1,
        'Amasty_Base' => 1,
        'Aitoc_Core' => 0,
        ...
        'Amasty_DeliveryDateManager' => 1,
        'Amasty_Feed' => 1,
        'Amasty_Gdpr' => 0,
        'Amasty_GdprCookie' => 0,
        'Amasty_GdprCookieHyva' => 0,
        'Amasty_GdprFrontendUi' => 0,
        'Amasty_GdprHyva' => 0,
        'Amasty_GdprPro' => 0,
        'Amasty_GdprProSubscriptionPackage' => 0,
        'Actuate_ReliantDirectTheme' => 1,
        ...
        'Amasty_ShippingSuiteProSubscriptionPackage' => 1,
        'Amasty_ShippingTableRates' => 1,
        'Amasty_Shiprestriction' => 1,
        'Amasty_Shiprules' => 1,
        'Amazon_Pay' => 1,
        'AutifyDigital_V12Finance' => 1,
        ...
        'Ced_Integrator' => 1,
        'Ced_Onbuy' => 1,
        'Craftyclicks_Ukpostcodelookup' => 1,
        'CtiDigital_CspWhitelist' => 1,
        'Ebizmarts_MailChimp' => 1,
        'Elgentos_CancelPendingOrders' => 1,
        'Fetchify_Fetchify' => 1,
        'FriendsOfHyva_PreloadImages' => 1,
        'GhoSter_OutOfStockAtLast' => 0,
        'Hyva_AmastyGdpr' => 0,
        'Hyva_AmazonPay' => 1,
        ...
        'Amasty_CheckoutDeliveryDateHyvaCompatibility' => 1,
        'Hyva_Email' => 1,
        'Hyva_GraphqlCart' => 0,
        ...
        'Amasty_CheckoutGiftWrapHyvaCompatibility' => 1,
        'Hyva_LumaCheckout' => 1,
        'WeltPixel_Backend' => 0,
        'Jajuma_AwesomeHyva' => 1,
        'Jajuma_HyvaFaq' => 1,
        'Hyva_JajumaWebpImages' => 1,
        'Klevu_Logger' => 1,
        'Klevu_Registry' => 1,
        'Klevu_Metadata' => 1,
        'Klevu_Search' => 1,
        ...
        'Mageplaza_RequiredLogin' => 1,
        'Mageside_SubscribeAtCheckout' => 1,
        'Hyva_BraintreeHyvaCheckout' => 1,
        'Magezon_Builder' => 1,
        ...
        'Mirasvit_GdprCookie' => 1,
        'Mirasvit_GdprConsent' => 1,
        'Hyva_MirasvitGdpr' => 1,
        ...
        'Hyva_MirasvitSearchAutocomplete' => 0,
        ...
        'Actuate_MirasvitSearchUltimate' => 0,
        'Actuate_MirasvitSeoFilter' => 1,
        'Mirasvit_SeoAi' => 1,
        'Mirasvit_SeoAudit' => 1,
        ...
        'Plumrocket_ProductFilterFixMagento245' => 0,
        'ReliantDirect_Checkout' => 1,
        'ReliantDirect_PriceDecimal' => 1,
        'Rvvup_Payments' => 1,
        'Rvvup_PaymentsHyvaCheckout' => 1,
        'Salesfire_Salesfire' => 1,
        'Scommerce_Core' => 1,
        'Scommerce_CspHelper' => 1,
        'Actuate_AwinAdvertiserTracking' => 1,
        ...
        'WeltPixel_GA4' => 0,
        'Hyva_WeltPixelGoogleTagManager' => 0,
        'WeltPixel_HyvaGA4' => 0
    ]
];
