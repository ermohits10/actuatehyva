...
use Ced\Onbuy\Model\ResourceModel\Profileproducts\CollectionFactory;
...
class Products extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \Ced\Onbuy\Model\ResourceModel\Profileproducts\CollectionFactory $collectionFactory,
    ...
    )
    {
        ...
        $this->_massactionBlockName = 'Ced\Onbuy\Block\Adminhtml\Profile\Widget\Grid\Massaction\Extended';
    ...
    {
        $profileAccount = $this->_coreRegistry->registry('onbuy_account');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            array(
                ...
                'sortable' => false,
                'type' => 'options',
                'options' => $this->_objectManager->create('Ced\Onbuy\Model\Source\Category')->getAllOptions(),
                'renderer' => 'Ced\Onbuy\Block\Adminhtml\Profile\Renderer\Category',
    ...
    public function getProducts($json = false)
    {
        ...
        $currentAccount = $this->_coreRegistry->registry('onbuy_account');
        $prods = $this->collectionFactory->create()->addFieldToFilter('account_id', $currentAccount->getId())->addFieldToFilter('profile_id', $profile->getId())->addFieldToSelect('product_id')->getData();
        $ids = $this->_objectManager->create('Ced\Onbuy\Model\Profile')->getCollection()/*->addFieldToFilter('profile_code', $profileCode)*/->getColumnValues('id');
        if (!empty($ids)) {
            $products = $this->_objectManager->get('Magento\Catalog\Model\Product')->getCollection()->addAttributeToFilter('entity_id', ['in' => $prods] )->getColumnValues('entity_id');
        }
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem(
            'addproduct', array(
                ...
                'url' => $this->getUrl('onbuy/profile/save'),
            )
        );
        return $this;
    }
