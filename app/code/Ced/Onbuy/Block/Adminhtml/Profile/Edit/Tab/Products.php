...
class Products extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @var string
     */
    protected $_template = 'Ced_Onbuy::widget/grid/extended.phtml';
...
//            ->setStoreId((int) $profileAccount->getAccountStore())
    ...
    public function getProducts($json = false)
    {
        ...
        $prods = $this->collectionFactory->create()->addFieldToFilter('account_id', $accountId)->addFieldToFilter('profile_id', $profileId)->addFieldToSelect('product_id')->getData();
