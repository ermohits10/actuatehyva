...
/**
 * Class MassSyncStatus
 * @package Ced\Onbuy\Block\Adminhtml\Product
 */
class MassSyncStatus extends \Magento\Backend\Block\Widget\Container
{
    /**
     * MassSyncStatus constructor.
    ...
    )
    {
        ...
        $this->setTemplate('Ced_Onbuy::product/masssyncstatus.phtml');
    }
