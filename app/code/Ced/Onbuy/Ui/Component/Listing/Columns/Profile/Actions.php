...
/**
 * Class Actions
 * @package Ced\Onbuy\Ui\Component\Listing\Columns\Profile
 */
class Actions extends Column
{
    const URL_PATH_EDIT = 'onbuy/profile/edit';
    const URL_PATH_DELETE = 'onbuy/profile/delete';
    const URL_PATH_SYNC = 'onbuy/profile/sync';
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                ...
                if (isset($item['profile_code'])) {
                    $item[$name]['edit'] = [
                        'href' => $this->urlBuilder->getUrl(self::URL_PATH_EDIT, ['pcode' => $item['profile_code'],'account_id'=>$item['account_id']]),
                        'label' => __('Edit'),
