...
class MassSync extends Action
{
    ...
    public function execute()
    {
        ...
        if (!empty($ids)) {
            ...
            $resultPage->getConfig()->getTitle()->prepend(__('Sync Price Inventory On OnBuy'));
            return $resultPage;
        } else {
            $this->messageManager->addErrorMessage(__('No product available for Syn Or OPC is not assigned, kindly re upload the products.'));
