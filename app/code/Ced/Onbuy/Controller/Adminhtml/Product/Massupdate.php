...
class Massupdate extends Action
{
     ...
     * @param \Ced\Onbuy\Model\ResourceModel\Profileproducts\CollectionFactory $profileProducts
     * @param Filter $filter
     */
...
//        die('tyes');
        ...
        if (!empty($ids)) {
            ...
            $resultPage->getConfig()->getTitle()->prepend(__('Update Product On OnBuy'));
            return $resultPage;
        } else {
            $this->messageManager->addErrorMessage(__('No product available for Update.'));
