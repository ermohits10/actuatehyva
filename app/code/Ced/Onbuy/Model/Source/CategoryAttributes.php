 ...
 */
class CategoryAttributes extends \Magento\Eav\Model\Entity\Attribute\Source\AbstractSource
{
    public $_jdecode;
...
//        print_r($magentoattributeCodeArray);die;
//        $magentoattributeCodeArray[] = ['value' => 'default', 'label' => "--Set Default Value--"];
//        $magentoattributeCodeArray[] = ['value' => [], 'label' => 'Required Attributes'];
//        $magentoattributeCodeArray[] = ['value' => [], 'label' => 'Optional Attributes'];
