...
var klevuLandingTemplateFiltersCustom = `
    <% if(data.query[dataLocal].filters.length > 0 ) { %>
        <div class="kuFilters" role="navigation" data-position="left" aria-label="Product Filters" tabindex="0" x-data="{ expanded: false }">
            <div class="kuFiltersTitle block-title relative b-left block border border-[#126366] rounded-md p-3 md:border-0 md:roudned-none md:w-full md:bg-transparent md:pt-0 md:py-0 md:px-0 md:my-0 cursor-pointer" @click="expanded = ! expanded">
...
var landingPageProductAddToCartCustom = `
    <a class="w-full btn btn-primary justify-center mr-auto" href="<%=dataLocal.url%>" aria-label="View Product">
